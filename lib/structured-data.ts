...
export function getPersonSchema() {
  return {
    ...
    description:
      "Certified personal trainer and coach with 10+ years of experience helping men and women build strength, confidence, and lasting fitness through personal training and online coaching.",
    knowsAbout: [
      "Personal Training",
      "Online Coaching",
      "Nutrition Coaching",
