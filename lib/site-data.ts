...
export const TRUST_INDICATORS = [
  { label: "Certified Personal Trainer", value: "Level 3 & 4" },
  { label: "Women Coached", value: "250+" },
...
export const PERSONAL_TRAINING_PACKAGES: Package[] = [
  ...
  },
  {
    ...
    features: [
      "2x weekly 1-to-1 sessions",
      "Fully periodised programme",
      "Bespoke nutrition plan",
      "Weekly check-ins & adjustments",
      "24/7 WhatsApp accountability",
      "Complimentary supplements consult",
      "Final transformation shoot",
    ],
    cta: "Enquire Now",
  },
];
