...
const ROWS: ({ label: string } & Record<PlanKey, boolean>)[] = [
  ...
  { label: "Monthly check-in and Adjustments", bronze: false, silver: true, gold: false, platinum: false },
  { label: "Weekly check-in and Adjustments", bronze: false, silver: false, gold: true, platinum: false },
  ...
  { label: "Monthly 1-2-1 Training Session", bronze: false, silver: false, gold: false, platinum: true },
];

const PLANS: { key: PlanKey; name: string; price: string; highlighted?: boolean }[] = [
  { key: "bronze", name: "Bronze", price: "£25" },
  { key: "silver", name: "Silver", price: "£95" },
  { key: "gold", name: "Gold", price: "£175", highlighted: true },
